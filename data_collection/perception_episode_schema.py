...
def build_robot_section(policy_name: str, policy_steps: int, final_state: dict) -> dict:
    return {
        ...
        "fallback_backend": final_state.get("fallback_backend"),
        "fallback_used_count": final_state.get("fallback_used_count", 0),
        "avg_inference_latency_ms": final_state.get("avg_inference_latency_ms"),
        "avg_image_encoding_latency_ms": final_state.get("avg_image_encoding_latency_ms"),
        "action_schema": final_state.get("action_schema"),
