...
from robot_sim.dummy_backend import DummyRobotBackend


PROJECT_ROOT = Path(__file__).resolve().parents[1]
LOG_PATH = PROJECT_ROOT / "results" / "logs" / "robot_backend_pipeline_log.jsonl"
